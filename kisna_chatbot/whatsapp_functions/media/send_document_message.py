...
def send_file_message(phone_number: str, bot_response: dict):
    """Sends a file message to a phone number.

    bot_response must contain keys: url, filename, caption(optional)
    """
    logger.info(
        "Sending file message to phone number",
